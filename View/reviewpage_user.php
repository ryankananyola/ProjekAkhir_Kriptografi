<!DOCTYPE html>
  <html lang="en">
    ...
    <body>
        ...
        <center>
            <h1>Review</h1>
            <p>Silahkan tulis testimoni dan review Anda terhadap restoran dan pelayanan kami.</p>
        </center>

        <div align="center">
            <form action="../encrypt/enkripsi_review.php" method="POST" enctype="multipart/form-data">
                <textarea name="comment" id="Textarea1" rows="10" cols="50" placeholder="Tulis komentar Anda..." required></textarea> <br>
                
                <label for="file">Silakan tambahkan foto (jpg/jpeg/png):</label><br>
                <div class="col-lg-4">
                    <input class="form-control" type="file" id="file" name="file" accept="image/jpeg, image/png" required><br>
                </div>
